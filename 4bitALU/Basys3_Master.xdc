...
set_property PACKAGE_PIN W2 [get_ports {load}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {load}]
#set_property PACKAGE_PIN U1 [get_ports {sw[13]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {sw[13]}]
set_property PACKAGE_PIN T1 [get_ports {instruction[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {instruction[0]}]
set_property PACKAGE_PIN R2 [get_ports {instruction[1]}]					
...
set_property PACKAGE_PIN P3 [get_ports {regdata_out[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {regdata_out[0]}]
set_property PACKAGE_PIN N3 [get_ports {regdata_out[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {regdata_out[1]}]
set_property PACKAGE_PIN P1 [get_ports {regdata_out[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {regdata_out[2]}]
set_property PACKAGE_PIN L1 [get_ports {regdata_out[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {regdata_out[3]}]
	
	
##7 segment display
set_property PACKAGE_PIN W7 [get_ports {cath[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cath[0]}]
set_property PACKAGE_PIN W6 [get_ports {cath[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cath[1]}]
set_property PACKAGE_PIN U8 [get_ports {cath[2]}]					
...
set_property PACKAGE_PIN U5 [get_ports {cath[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cath[4]}]
set_property PACKAGE_PIN V5 [get_ports {cath[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cath[5]}]
set_property PACKAGE_PIN U7 [get_ports {cath[6]}]					
