...
set_property PACKAGE_PIN W2 [get_ports {an_in[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an_in[0]}]
set_property PACKAGE_PIN U1 [get_ports {an_in[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an_in[1]}]
set_property PACKAGE_PIN T1 [get_ports {an_in[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an_in[2]}]
set_property PACKAGE_PIN R2 [get_ports {an_in[3]}]					
