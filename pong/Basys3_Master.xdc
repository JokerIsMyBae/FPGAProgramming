...
## Switches
set_property PACKAGE_PIN V17 [get_ports {SW_P}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SW_P}]
set_property PACKAGE_PIN V16 [get_ports {SW_S}]					
...
set_property PACKAGE_PIN U1 [get_ports {SW_AI2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SW_AI2}]
set_property PACKAGE_PIN T1 [get_ports {SW_AI1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SW_AI1}]
set_property PACKAGE_PIN R2 [get_ports {SW_C}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SW_C}]
